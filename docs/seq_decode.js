...
$(document).ready(function () {
    ...
    $('div[id="genmicrocode"]').each(function()
					 ...
					 var html = "<table id='Microcode" + $(this).data('id') + "' class='codeop'>\
<tr>";
					 var attr = $(this).attr('data-int');
					 if (typeof attr !== typeof undefined && attr !== false) {
					     // Element has this attribute
					     console.log("int");
					     html += "<td colspan='2'><i class='material-icons'>clear</i></td>";
...
<th colspan='1'>INTA</th>";
					     ...
					     html += "<td colspan='6'><i class='material-icons'>clear</i></td>";
					 }
...
<td><input type='text' id='microcode"+$(this).data('id')+"' size='15' maxLength='10' value='0x00000000' onchange='fromCode("+$(this).data('id')+")'></td>";
					 ...
					 html += "<input type='button' value='Reinitialiser le code' onclick='initCode("+$(this).data('id')+");'/>";
					 $(this).html($(html));
				     });
